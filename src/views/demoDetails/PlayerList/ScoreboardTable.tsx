      ...
      <div>
        <table className={"scoreboard"}>
          ...
          <tbody>
            ...
            <tr>
              <td className={"score-label"}>Kills:</td>
              <td
                className={
                  scoreboard.kills == 0
                    ? "score-value zero-score"
                    : "score-value non-zero-score"
                }
              >
                {scoreboard.kills}
              </td>
              <td className={"score-label"}>Captures:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Invulns:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Backstabs:</td>
              <td
                className={
            ...
            <tr>
              <td className={"score-label"}>Deaths:</td>
              <td
                className={
                  scoreboard.deaths == 0
                    ? "score-value zero-score"
              ...
              <td className={"score-label"}>Defenses:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Headshots:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Bonus:</td>
              <td
                className={
            ...
            <tr>
              <td className={"score-label"}>Assists:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Domination:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Teleports:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Support:</td>
              <td
                className={
            ...
            <tr>
              <td className={"score-label"}>Destruction:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Revenge:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Healing:</td>
              <td
                className={
              ...
              <td className={"score-label"}>Damage:</td>
              <td
                className={
