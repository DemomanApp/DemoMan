...
impl Filters {
    ...
    fn matches(&self, demo: &Demo) -> bool {
        dbg!(self, demo);
        dbg!(self.matches_type(demo))
            && dbg!(self.matches_event(demo))
            && dbg!(self.matches_name(demo))
            && dbg!(self.matches_free_text(demo))
            && dbg!(self.matches_map(demo))
            && dbg!(self.matches_client(demo))
            && dbg!(self.matches_tag(demo))
    }
